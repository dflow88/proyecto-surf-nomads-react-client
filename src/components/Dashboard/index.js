...
export default function Dashboard() {
    ...
    return (
        ...
        <div class="h-screen flex overflow-hidden bgWhite">
            {/* <div class="fixed inset-0 flex z-40 md:hidden" role="dialog" aria-modal="true">

                <div class="fixed inset-0 bg-gray-600 bg-opacity-75" aria-hidden="true"></div>
                <div class="relative flex-1 flex flex-col maxW-xs w-full bgWhite">
                    <div class="absolute top-0 right-0 -mr-12 pt-2">
                        <button
                            class="ml-1 flex items-center justify-center h-10 w-10 rounded-full focus:outline-none focus:ring-2 focus:ring-inset focus:ringWhite">
                            <span class="sr-only">Close sidebar</span>
                            <svg class="h-6 w-6 textWhite" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            ...
            <div class="hidden md:flex md:flex-shrink-0">
                <div class="flex flex-col w-64">
                    <div class="flex-1 flex flex-col min-h-0 border-r border-gray-200 bgWhite">
                        <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">

                            <nav class="mt-5 flex-1 px-2 bgWhite space-y-1">
                                ...
                                <button onClick={(e) => {activateProfile(e)}}
                                    class={
                                        profileActive ?
                                        "bg-gray-100 text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md"
                                        : "text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md"
            ...
            <div class="flex flex-col w-0 flex-1 overflow-hidden">
                ...
                <main class="flex-1 relative z-0 overflow-y-auto focus:outline-none">
                    <div class="py-6">
                        ...
                        <div class="maxW-7xl mx-auto px-4 sm:px-6 md:px-8">
                            <div class="py-4">
